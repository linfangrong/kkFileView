        ...
        public void run() {
            try {
                ...
                while (true) {
                    ...
                    downloadOrigin = Boolean.parseBoolean(properties.getProperty("download.origin", ConfigConstants.DEFAULT_DOWNLOAD_ORIGIN));
                    ...
                    ConfigConstants.setDownloadOrigin(downloadOrigin);
